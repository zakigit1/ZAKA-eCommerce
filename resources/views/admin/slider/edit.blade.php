    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.slider.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"
                            ...
                            <form action="{{ route('admin.slider.update', $slider->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type" class="form-control" id=""
                                        placeholder="Type" value="{{ $slider->type }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="starting_price" class="form-control" id="starting_price"
                                        placeholder="Starting Price" value="{{ $slider->starting_price }}">
                                </div>
                                <div class="form-group">
                                    <label for="btn_url">Button URL</label>
                                    <input type="text" name="btn_url" class="form-control" id="btn_url"
                                        placeholder="Button URL" value="{{ $slider->btn_url }}">
                                </div>
                                <div class="form-group">
                                    <label for="serial">Serial</label>
                                    <input type="text" name="serial" class="form-control" id="serial"
                                        placeholder="Serial" value="{{ $slider->serial }}">
                                </div>
                                <div class="form-group ">
                                    <label for="inputStatus">Status</label>
                                    <select class="form-control" id="inputStatus" placeholder="Status" name="status">

                                        <option @if ($slider->status) selected @endif value="1">active
                                        </option>
