    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.product-variant-item.index', [$product_id, $variant_id]) }}" class="btn btn-icon"><i
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a
                        href="{{ route('admin.product-variant.index', ['id' => $product_id]) }}">Product Variants</a></div>
                <div class="breadcrumb-item"><a
                        href="{{ route('admin.product-variant-item.index', [$product_id, $variant_id]) }}">Product Variant
                        Items</a></div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 ">
                    {{-- <a href="{{ route('admin.product-variant-item.index', [$product_id, $variant_id]) }}"
                            ...
                            <form action="{{ route('admin.product-variant-item.update', $item->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" class="form-control"
                                        placeholder="Price (Set 0 for make it free)" value="{{ $item->price }}">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" name="is_default">
                                        ...
                                        <option @if ($item->is_default == 1) selected @endif value="1">Yes
                                        </option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" id="inputStatus" placeholder="Status" name="status">
                                        ...
                                        <option @if ($item->status == 1) selected @endif value="1">active
                                        </option>
