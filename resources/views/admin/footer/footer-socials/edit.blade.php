...
@section('title')
    {{ "$settings->site_name || Edit Footer Social " }}
@endsection
@section('content')
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.footer-socials.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 ">
                    {{-- <a href="{{ route('admin.footer-socials.index') }}" class="btn btn-primary "> <i
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.footer-socials.update', $footerSocial->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    <button id='icon' name="icon" data-icon="{{ $footerSocial->icon }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id=""
                                        placeholder="Social Name" value="{{ $footerSocial->name }}">
                                </div>

                                <div class="form-group">
                                    <label for="type">Social URL</label>
                                    <input type="text" name="url" class="form-control" placeholder="Social URL"
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" id="inputStatus" placeholder="Status" name="status">
                                        ...
                                        <option @if ($footerSocial->status) selected @endif value="1">active
                                        </option>
