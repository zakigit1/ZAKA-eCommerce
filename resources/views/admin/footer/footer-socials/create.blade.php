                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.footer-socials.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <button id='icon' name="icon" {{-- style="font-size: 2rem" --}} class="btn btn-warning"
                                        role="iconpicker" data-align="right" data-rows="8" data-cols="10"
                                        data-arrow-class="btn-info" data-arrow-prev-icon-class="fas fa-angle-left"
