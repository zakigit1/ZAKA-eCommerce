...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Manage Footer Grid Three</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{route('admin.dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item">Footer Grid Three</div>
            </div>
        </div>
                            ...
                            <form action="{{route('admin.footer-grid-three.change-title')}}" method="POST">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group d-flex">
                                        <input type="text" class="form-control" name="title" value="{{@$footerGridThreeTitle}}">
        ...
        <div class="section-body">
            <div class="row">
                ...
                {{-- <div class="container"> --}}
                    <div class="card">
                        <div class="card-header">
                            <h4>Footer Grid Three Information</h4>
