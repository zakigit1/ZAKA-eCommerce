...
@section('title')
    {{ @$settings->site_name . ' || Admin Dashboard analysis ' }}
@endsection
                    ...
                    <div class="card card-statistic-2">
                        <div class="card-stats">
                            ...
                            <div class="card-stats-items">
                                ...
                                <div class="card-stats-item">
                                    <div class="card-stats-item-count">{{ $totalCompleteOrders }}</div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card card-statistic-2">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ @$settings->currency_icon }} {{ $balance }}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body" id="top-5-scroll">
                            <ul class="list-unstyled list-unstyled-border">
                                @foreach ($topProducts as $product)
                                    <li class="media">
                                        <img class="mr-3 rounded" width="55" src="{{asset('storage/Uploads/images/products/thumb-images/'.$product->thumb_image)}}"
                                            alt="product">
                                        <div class="media-body">
                                            <div class="float-right">
                                            ...
                                            <div class="mt-1">
                                                <div class="budget-price">
                                                    <div class="budget-price-square bg-primary"
                                                        data-width="{{ (($product->total_amount / $product->total_sales) * 100) / 1000 }}%">
                                                    </div>
                                                    <div class="budget-price-label">
                                                        {{ @$settings->currency_icon }}{{ number_format($product->total_amount, 2) }}
                                                    </div>
                                                </div>
                                                <div class="budget-price">
                                                    <div class="budget-price-square bg-danger"
                                                        data-width="{{ ($product->avg_price * $product->total_sales * 100) / 1000 }}%">
                                                    </div>
                                                    <div class="budget-price-label">
                                                        {{ @$settings->currency_icon }}{{ number_format($product->avg_price * $product->total_sales, 2) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
