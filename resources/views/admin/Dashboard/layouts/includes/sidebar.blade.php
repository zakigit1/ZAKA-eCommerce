    ...
    <aside id="sidebar-wrapper scroll-down">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.order.pending']) }}"><a class="nav-link"
                            href="{{ route('admin.order.pending') }}">All Pending Orders</a></li>
                    <li class="{{ setActive(['admin.order.processing']) }}"><a class="nav-link"
                            href="{{ route('admin.order.processing') }}">All Processing Orders</a></li>
                    ...
                    <li class="{{ setActive(['admin.order.trashed-orders']) }}"><a class="nav-link"
                            href="{{ route('admin.order.trashed-orders') }}">All Trashed Orders</a></li>
            ...
            <li class="{{ setActive(['admin.transaction.index']) }}"><a class="nav-link"
                    href="{{ route('admin.transaction.index') }}"><i class="fas fa-money-check-alt"></i><span>All
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                        class="fas fa-stream"></i><span>Ecommerce</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown  {{ setActive(['admin.withdraw-method.*', 'admin.withdraw-request-list.*']) }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.withdraw-method.*']) }}"><a class="nav-link"
                            href="{{ route('admin.withdraw-method.index') }}">Withdraw Methods</a></li>
                    <li class="{{ setActive(['admin.withdraw-request-list.*']) }}"><a class="nav-link"
                            href="{{ route('admin.withdraw-request-list.index') }}">Withdraw Request List </a></li>
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                        class="fas fa-store"></i><span>Manage Website</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.slider.*']) }}"><a class="nav-link"
                            href="{{ route('admin.slider.index') }}">Slider</a></li>
                    <li class="{{ setActive(['admin.home-page-setting.index']) }}"><a class="nav-link"
            ...
            {{-- Messanger --}}
            <li class="{{ setActive(['admin.messager.index']) }}"><a class="nav-link"
                    href="{{ route('admin.messager.index') }}"><i
                        class="fas fa-comment-alt"></i><span>Messanger</span></a></li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.vendor-request.approved']) }}"><a class="nav-link"
                            href="{{ route('admin.vendor-request.approved') }}">Approved Vendor Request</a></li>
            ...
            <li class="{{ setActive(['admin.subscriber.*']) }}"><a class="nav-link"
                    href="{{ route('admin.subscriber.index') }}"><i class="fas fa-handshake"></i>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.footer-info.index']) }} sidebar-scroll-down"><a class="nav-link"
