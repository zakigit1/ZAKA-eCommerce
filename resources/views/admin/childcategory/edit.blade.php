...
@section('title')
    {{"$settings->site_name || Edit Admin Child Category "}}
@endsection
@section('content')
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.child-category.update',$childcategory->id)}}" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="" placeholder="Childcategory Name" value="{{$childcategory->name}}">
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" id="inputStatus" placeholder="Status" name="status">
                                    ...
                                    <option @if($childcategory->status) selected @endif value="1">active</option>
