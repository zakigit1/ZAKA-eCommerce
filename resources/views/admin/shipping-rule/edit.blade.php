...
@section('title')
    {{"$settings->site_name ||Edit Admin Shipping Rule  "}}
@endsection
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.shipping-rules.update',$shippingRule->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"  placeholder="Coupon Name" value="{{$shippingRule->name}}">
                                </div>
                                ...
                                <div class="form-group min-cost d-none">
                                    ...
                                    <input type="text" name="min_cost" class="form-control"  placeholder="Minimum Amount" value="{{$shippingRule->min_cost}}">
                                </div>
                                <div class="form-group">
                                    <label> Cost </label>
                                    <input type="text" name="cost" class="form-control"  placeholder="Cost" value="{{$shippingRule->cost}}">
                                </div>
