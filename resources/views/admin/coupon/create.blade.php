                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.coupons.store')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"  placeholder="Coupon Name" value="{{old('name')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="1000" name="quantity" class="form-control"  placeholder="Quantity" value="{{old('quantity')}}">
                                </div>
                                <div class="form-group">
                                    <label for="type">Max Use Per Person</label>
                                    <input type="number" min="1" max="20" name="max_use" class="form-control"  placeholder="Max Use" value="{{old('max_use')}}">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="discount" class="form-control"  placeholder="Discount Value" value="{{old('discount')}}">
                                        </div>
                                    </div>
