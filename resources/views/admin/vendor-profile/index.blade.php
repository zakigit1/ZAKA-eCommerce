...
@section('title')
    {{ @$settings->site_name ." || Admin Vendor Profile  " }}
@endsection
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Admin Vendor Profile</div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.vendor-profile.update') }}" method="post"
                                ...
                                <div class="form-group wsus__input">
                                    ...
                                    <input type="text" name="shop_name" class="form-control" id=""
                                        placeholder="Shop Name" value="{{ $profile->shop_name }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Twitter </label>
                                    <input type="text" name="tw_link" class="form-control" placeholder="Twitter Link"
                                        value="{{ $profile->tw_link }}">
                                </div>
                                <div class="form-group">
                                    <label>Instgrame </label>
                                    <input type="text" name="insta_link" class="form-control"
                                        placeholder="Instagram Link" value="{{ $profile->insta_link }}">
                                </div>
