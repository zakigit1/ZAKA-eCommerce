                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                            ...
                            <p class="total"><span>total:</span> <span id="cart_total">{{$settings->currency_icon}} {{cartTotal()}}</span></p>
                            ...
                            <div class="wsus__single_banner_img">
                                ...
                                @if ($cartpageBanner[2]->status == 1)
                                    <a href="{{$cartpageBanner[0]->banner_1->banner_url_1}}">
                                        <img src="{{asset($cartpageBanner[0]->banner_1->banner_image_1)}}" alt="banner" class="img-fluid w-100">
                                    </a>
                                @endif
                        ...
                        <div class="wsus__single_banner_content single_banner_2">
                            <div class="wsus__single_banner_img">
                                ...
                                <a href="{{$cartpageBanner[1]->banner_2->banner_url_2}}">
                                    <img src="{{asset($cartpageBanner[1]->banner_2->banner_image_2)}}" alt="banner" class="img-fluid w-100">
                                </a>
                            @endif
                            </div>
