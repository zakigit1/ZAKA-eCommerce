                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="wsus__check_form">
                            <h5>Addresses Details <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">add
                                    new address</a></h5>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.shipping-method').on('click',  function(){
                ...
                let totalAmount = (currentTotalAmount + shippingFee).toFixed(2);// toFixed(2) function use for take from total amount just two number after cuma
