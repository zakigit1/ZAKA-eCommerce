                        ...
                        <div class="">
                            <div class="wsus__invoice_area">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-md-4 mb-5 mb-md-0">
                                                <div class="wsus__invoice_single">
                                                    ...
                                                    <p>{{ $order_address->city }} ,{{ $order_address->state }}
                                                        ,{{ $order_address->zip }} </p>
                                            ...
                                            <div class="col-xl-4 col-md-4">
                                                <div class="wsus__invoice_single text-md-end">
                                                    ...
                                                    <p>Payment Status :
                                                        {{ $order->payment_status == 1 ? 'Complete' : 'Pending' }} </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach ($order->orderProducts as $product)
                                                    <tr>
                                                        ...
                                                        <td class="images">
                                                            <img src="{{ $product->product->thumb_image }}" alt="bag"
                                ...
                                <div class="wsus__invoice_footer">
                                    <p><span><strong> Subtotal
                                                :</strong></span>{{ $settings->currency_icon }}{{ $order->sub_total }}</p>
                                    <p><span><strong> Shipping (+)
                                                :</strong></span>{{ $settings->currency_icon }}{{ @$shipping_method->cost }}
                                    </p>
                                    <p><span><strong> Coupon
