...
@section('title')
    {{"$settings->site_name || Vendor Order Trashed "}}
@endsection
                                ...
                                @if(isset($trashed_orders) && count($trashed_orders))
                                    @foreach ($trashed_orders as $trashed_order)          
                                        <tr>
                                            ...
                                            <td>  
                                                <div class="d-flex">
                                                    <a class="btn-sm btn-primary btn mx-2" href="{{route('vendor.order.trashed-orders.restore', $trashed_order->id)}}">Restore <i class="fas fa-undo"></i></a>
                                                    <a class="btn-sm btn-danger btn mx-2" href="{{route('vendor.order.trashed-orders.delete', $trashed_order->id)}}">Delete <i class='fas fa-trash-alt'></i></a>
                                                </div>
